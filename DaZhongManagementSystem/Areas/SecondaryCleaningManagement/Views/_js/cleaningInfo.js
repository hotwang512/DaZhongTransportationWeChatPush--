        ...
        selector.$grid().jqxDataTable(
            {
                ...
                columns: [
                  ...
                  { text: '业务类型', datafield: 'CouponType', width: 200, align: 'center', cellsAlign: 'center', },
                  { text: '车辆', datafield: 'CabLicense', width: 150, align: 'center', cellsAlign: 'center' },
                  { text: '车辆所属公司', datafield: 'CabOrgName', width: 200, align: 'center', cellsAlign: 'center' },
                  { text: '当前司机', datafield: 'CreatedUser', width: 150, align: 'center', cellsAlign: 'center' },
                  { text: '司机所属公司', datafield: 'ManOrgName', align: 'center', width: 200, cellsAlign: 'center' },
                  { text: '操作地点', datafield: 'CompanyName', align: 'center', width: 350, cellsAlign: 'center' },
