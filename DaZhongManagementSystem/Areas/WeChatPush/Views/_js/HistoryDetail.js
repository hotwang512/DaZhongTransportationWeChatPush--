...
var $page = function () {
    ...
    function addEvent() {
        ...
        selector.$btnBack().on('click', function () {
            window.location.href = "/WeChatPush/History/History";
        });
                   ...
                   '<td>' +
                    ...
                    '<tr style="height:45px;">' +
                        ...
                        '<td class="pushHistory">' +
                            '<input id="chkHistory" type="checkbox" disabled="disabled" checked="checked" style="width: 17px; height: 17px;background-color:#f5f5f5!important;">' +
                       ' </td>' +
                       '</tr>' +
                       '<tr style="height: 45px;">' +
