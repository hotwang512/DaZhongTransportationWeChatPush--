        ...
        var source =
            {
                ...
                url: "/WeChatPush/RedPacketOperation/GetRedPacketHistoryList"    //获取数据源的路径
            };
        ...
        selector.$grid().jqxDataTable(
            {
                ...
                theme: "office",
                columns: [
                  { text: '姓名', width: '14%', datafield: 'Name', align: 'center', cellsAlign: 'center' },
                  { text: '手机号', width: '14%', datafield: 'UserID', align: 'center', cellsAlign: 'center' },
                  { text: '金额(元)', width: '11%', datafield: 'RedpacketMoney', align: 'center', cellsAlign: 'center',cellsformat:"d2" },
                  { text: '发送时间', width: '14%', datafield: 'CreatedDate', align: 'center', cellsAlign: 'center', datatype: 'date', cellsformat: "yyyy-MM-dd HH:mm:ss" },
                  { text: '红包状态', width: '14%', datafield: 'transRedpacketStatus', align: 'center', cellsAlign: 'center' },
                  ...
                  { text: '失败原因', width: '18%', datafield: 'Reson', align: 'center', cellsAlign: 'center' },
