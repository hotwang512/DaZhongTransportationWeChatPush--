var selector = {
    $grid: function () { return $("#ExerciseReportList") },
            ...
            success: function (data) {
                if ($("#ExercisesName_Search").val() != "") {
                    ...
                    var charts = [
                        ...
                        { title: '优秀及格率', label: 'W3C', dataSource: dataW3CCounter },
                        { title: '答题次数比', label: 'Wikimedia', dataSource: dataWikimedia }
                    ];
        ...
        var UserListSource =
            {
                datafields:
                [
                    { name: 'BusinessExersDetailVguid', type: 'string' },
                    { name: 'Correct', type: 'string' },
                    { name: 'ExerciseNameDetail', type: 'string' }
                ],
                datatype: "json",
                id: "BusinessExersDetailVguid",//主键
                async: true,
                data: { "vguid": vguid, "departmentVguid": selector.$txtDeparment().val() },
                url: "/ReportManagement/ScoreReport/GetExerciseDetail"    //获取数据源的路径
            };
        ...
        selector.$grid().jqxDataTable(
            {
                ...
                theme: "office",
                columns: [
                  { text: '习题名称', datafield: 'ExerciseNameDetail', align: 'center', cellsAlign: 'left' },
                  { text: '正确率', datafield: 'Correct', align: 'center', cellsAlign: 'center', cellsRenderer: addPercent },
                  { text: 'VGUID', datafield: 'BusinessExercisesDetailVguid', hidden: true }
                ]
            });
    }
